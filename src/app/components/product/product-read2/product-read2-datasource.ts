...
export class ProductRead2DataSource extends DataSource<Product> {
  data: Product[] = EXAMPLE_DATA; //data > tabela
  paginator: MatPaginator | undefined; //paginator > paginador
  sort: MatSort | undefined; //sort que vai fazer ordenação dos dados
